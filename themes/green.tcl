...
namespace eval ttk::theme::azure-green {
    variable version 2.0
    package provide ttk::theme::azure-green $version

    ttk::style theme create azure-green -parent clam -settings {
        ...
        load_images [file join [file dirname [info script]] green]
