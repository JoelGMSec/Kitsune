...
namespace eval ttk::theme::azure-purple {
    variable version 2.0
    package provide ttk::theme::azure-purple $version

    ttk::style theme create azure-purple -parent clam -settings {
        ...
        load_images [file join [file dirname [info script]] purple]
        ...
        ttk::style element create Vertical.Scrollbar.thumb \
            image [list $I(vert-accent) \
                ...
                pressed $I(vert-accent) \
                active $I(vert-accent) \
            ] -sticky ns
        ...
        ttk::style element create Combobox.button \
            image [list $I(combo-button-basic) \
                ...
                {readonly focus hover} $I(combo-button-hover) \
                {readonly focus} $I(combo-button-hover) \
                {readonly hover} $I(combo-button-hover) \
        ...
        ttk::style element create Spinbox.button \
            image [list $I(combo-button-basic) \
                 ...
                 {readonly focus} $I(combo-button-focus) \
                 {readonly hover} $I(combo-button-focus)
            ] -border 5 -padding {2 6 6 6}
        ...
        ttk::style element create Notebook.tab \
            image [list $I(tab-disabled) \
                ...
                active $I(tab-basic) \
                disabled $I(tab-notify) \
            ] -border 5 -padding {14 8}
        ...
        ttk::style element create Treeheading.cell \
            ...
            ] -border 5 -padding 16 -sticky ewns
