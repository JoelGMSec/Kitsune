...
namespace eval ttk::theme::azure-red {
    variable version 2.0
    package provide ttk::theme::azure-red $version

    ttk::style theme create azure-red -parent clam -settings {
        ...
        load_images [file join [file dirname [info script]] red]
