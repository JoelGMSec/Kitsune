...
namespace eval ttk::theme::azure-blue {
    variable version 2.0
    package provide ttk::theme::azure-blue $version

    ttk::style theme create azure-blue -parent clam -settings {
        ...
        load_images [file join [file dirname [info script]] blue]
