...
RUN apt-get update && apt-get install -y sudo git zip wget proxychains
...
RUN apt-get update && apt install -y build-essential gcc-mingw-w64-x86-64-win32 python3-pip python3-tk python3.11
